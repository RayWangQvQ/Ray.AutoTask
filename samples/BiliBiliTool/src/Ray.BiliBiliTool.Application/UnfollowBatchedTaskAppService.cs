...
{
    public class UnfollowBatchedTaskAppService : AutoTaskAppService, IUnfollowBatchedTaskAppService
    {
        ...
        public UnfollowBatchedTaskAppService(
            ...
            ) : base(logger, unfollwBatchedTaskOptions.CurrentValue.RandomSleepMaxMin, securityOptions.CurrentValue.RandomSleepMaxMin)
        {
