...
{
    public class DailyTaskAppService : AutoTaskAppService, IDailyTaskAppService
    {
        ...
        ) : base(logger, dailyTaskOptions.CurrentValue.RandomSleepMaxMin, securityOptions.CurrentValue.RandomSleepMaxMin)
        {
            _logger = logger;
