...
{
    public class LiveLotteryTaskAppService : AutoTaskAppService, ILiveLotteryTaskAppService
    {
        ...
        public LiveLotteryTaskAppService(
            ...
            ) : base(logger, liveLotteryTaskOptions.CurrentValue.RandomSleepMaxMin, securityOptions.CurrentValue.RandomSleepMaxMin)
        {
